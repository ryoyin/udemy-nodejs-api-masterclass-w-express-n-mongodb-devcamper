...
exports.udpateBootcamp = asyncHandler(async (req, res, next) => {
    ...
    if(bootcamp.user.toString() !== req.user.id && req.user.role !== 'admin') {
        return next(new ErrorResponse(`You do not have permission to update this record`, 401))
    }
...
exports.deleteBootcamp = asyncHandler(async (req, res, next) => {
    ...
    // check ownership
    if(bootcamp.user.toString() !== req.user.id && req.user.role !== 'admin') {
        return next(new ErrorResponse(`You do not have permission to delete this record`, 401))
    }
...
exports.bootcampPhotoUpload = asyncHandler(async (req, res, next) => {
    ...
    // check ownership
    if(bootcamp.user.toString() !== req.user.id && req.user.role !== 'admin') {
        return next(new ErrorResponse(`You do not have permission to upload photo to this record`, 401))
    }
